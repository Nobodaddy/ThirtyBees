...
<div id="carrier_area">
    ...
    <form id="form" action="{$link->getPageLink('order', true, NULL, "{if $multi_shipping}multi-shipping={$multi_shipping}{/if}")|escape:'html':'UTF-8'}" method="post" name="carrier_area">
        ...
        <div id="carrier_area" class="opc-main-block">
            <h1 class="page-heading">{l s='Delivery methods'}</h1>
                                            ...
                                            {foreach $option_list as $key => $option}
                                                <div class="delivery_option {if ($option@index % 2)}alternate_{/if}item">
                                                    <div>
                                                        ...
                                                        {if !$option.unique_carrier}
                                                            <table class="delivery_option_carrier{if isset($delivery_option[$id_address]) && $delivery_option[$id_address] == $key} selected{/if} resume table table-bordered resp_table {if $option.unique_carrier} hide{/if}">
                                                                <tr>
                                                                    {if !$option.unique_carrier}
